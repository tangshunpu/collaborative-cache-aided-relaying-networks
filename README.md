...
- Recomputed result CSV/PNG/PDF/EPS files under `results/`.
...
The figure grid below uses the paper result figures newly regenerated by the
Python scripts in `results/`:

![Recomputed paper result figures](results/paper_results_grid.png)
...
│   └── fig_*.{csv,png,pdf,eps} # per-figure recomputed outputs
